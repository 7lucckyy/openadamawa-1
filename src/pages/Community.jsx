...
function Community() {
  ...
  return (
    <Container className="pt-5">
        <Row className="fw-bold text-lg-center mb-5">
            <Col xs={12} lg={4}>
                <Form.Group>
                    <Form.Label>Select LGA</Form.Label>
                    <Form.Select className="rounded-3" value={photoForLGA} onChange={(event)=> {handleChange(event.target.value); console.log(event.target.name)}}>
